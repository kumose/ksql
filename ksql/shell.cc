...
#include <ksql/shell/shell_progress_bar.h>
...
void ShellState::Initialize() {
    ...
    default_prompt = "{max_length:40}{highlight_element:prompt}{setting:current_database_and_schema}{color:reset} {color:green}K>>>{color:reset} ";
